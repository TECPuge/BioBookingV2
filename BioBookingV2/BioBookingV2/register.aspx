        ...
        <div>
            <div style="font-family: Arial">
                <table style="border: 1px solid black">
                    ...
                    <tr>
                        <td>Login name</td>
                        <td>:<asp:TextBox ID="txtUserName" runat="server" OnTextChanged="txtUserName_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="auto-style1">:<asp:TextBox ID="Firstname" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td>Last name</td>
                        <td>:<asp:TextBox ID="Lastname" runat="server" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>:<asp:TextBox ID="txtPassword" TextMode="Password" runat="server" OnTextChanged="txtPassword_TextChanged">
                        </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>:<asp:TextBox ID="txtConfirmPassword" TextMode="Password" runat="server" OnTextChanged="txtConfirmPassword_TextChanged">
                        </asp:TextBox>
